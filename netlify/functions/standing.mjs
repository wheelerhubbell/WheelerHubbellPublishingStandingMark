...
export const config={path:['/','/v1/*','/.well-known/whp-standing.json','/.well-known/standing-capability.json','/.well-known/x402','/openapi.json','/discovery/*','/verification/*','/examples/*','/.well-known/api-catalog','/healthz','/schemas/*','/mcp','/server.json','/robots.txt','/sitemap.xml','/llms.txt']};
