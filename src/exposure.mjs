...
export const exposurePaths=['/discovery/applicability.json','/discovery/recursive-use.json','/discovery/capability.json','/discovery/provider-index.json','/.well-known/standing-capability.json','/.well-known/api-catalog','/server.json','/llms.txt'];
